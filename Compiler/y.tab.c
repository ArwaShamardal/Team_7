...
static const char *const yytname[] =
{
  ...
  "SWITCH", "CASE", "BREAK", "CONTINUE", "RETURN", "INTEGER", "CHARACTER",
  "FLOAT", "STRING", "DOUBLE", "BOOLEAN", "CONSTANT", "VOID",
  "VAL_INTEGER", "VAL_FLOAT", "VARIABLE", "'='", "'+'", "'-'", "'*'",
  "'/'", "'%'", "UMINUS", "$accept", "Starter", "Digit", 0
};
#endif
